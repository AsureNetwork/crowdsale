...
contract Crowdsale is ReentrancyGuard {
    ...
    constructor (uint256 rate, address payable wallet, IERC20 token) public {
        require(rate > 0,"1");
        require(wallet != address(0),"2");
        require(address(token) != address(0),"3");
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        require(beneficiary != address(0), "crowdsale beneficiary != address(0)");
        require(weiAmount != 0,"crowdsale weiAmount != 0");
    }
...
contract TimedCrowdsale is Crowdsale {
    ...
    constructor (uint256 openingTime, uint256 closingTime) public {
        ...
        require(openingTime >= block.timestamp,"9 openingTime >= block.timestamp");
        require(closingTime > openingTime,"10");
...
contract WhitelistCrowdsale is WhitelistedRole, Crowdsale {
    ...
    */
    function _preValidatePurchase(address _beneficiary, uint256 _weiAmount) internal view {
        require(isWhitelisted(_beneficiary),"isWhitelisted(_beneficiary)");
...
contract TokenVesting is Ownable {
    ...
    constructor (address beneficiary, uint256 start, uint256 cliffDuration, uint256 duration, bool revocable) public {
        ...
        require(cliffDuration <= duration,"23");
        require(duration > 0,"4");
        require(start.add(duration) > block.timestamp,"5");
...
// File: contracts\AsureCrowdsaleDeployer.sol
